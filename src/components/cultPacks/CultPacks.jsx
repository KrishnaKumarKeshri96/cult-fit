      ...
      <div className={styles.rightContainer}>
        ...
        <div className={styles.contentWrapper}>
          ...
          <div className={styles.subtitle}>
            ...
            months Every Cult centre offers a plethora of group workout formats
            designed and run by highly qualified fitness experts. These workouts
            are great for newbies and fitness veterans alike, and are guaranteed
            to show results.
          </div>
        </div>
        ...
        <div className={styles.contentWrapper}>
          ...
          <div className={styles.subtitle}>
            ...
            <p>
              Cult centers: Book a class that you like. Reach the center on time
          ...
          <div className={styles.subtitle}>
            ...
            <p>
              Live workouts: Choose from the wide variety of online workouts and
